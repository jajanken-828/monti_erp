...
import {
    ...
    Eye, Edit3, User, Mail, Phone, Briefcase
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <button @click="form.status = 'Hired'"
                                :class="form.status === 'Hired' ? 'bg-emerald-500 text-white ring-4 ring-emerald-100' : 'bg-slate-50 text-slate-400'"
                                class="py-4 rounded-2xl font-black text-[10px] uppercase transition-all">Hire</button>
                            <button @click="form.status = 'Rejected'"
                                ...
                                class="py-4 rounded-2xl font-black text-[10px] uppercase transition-all">Reject</button>
                        </div>
                    </div>
